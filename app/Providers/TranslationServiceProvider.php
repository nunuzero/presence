...
class TranslationServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Section::macro('localizeLabel', function (string | Htmlable | Closure | null $customLabel = null): static {
            return TranslationServiceProvider::localizeLabelGeneric($this, $customLabel);
        });
    ...
    public static function localizeLabelGeneric($object, string | Htmlable | Closure | null $customLabel = null)
    {
        ...
        try {
            ...
            throw new \RuntimeException("Error localizing label: '{$label}'. Original error: {$e->getMessage()}", 0, $e);
        }
